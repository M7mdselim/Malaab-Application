    ...
    private static void LoadSqlConfiguration()
    {
        ...
        if (File.Exists(configPath))
        {
            ...
            if (lines.Length >= 3)
            {
              ...
              //connectionString = $"Data Source=DESKTOP-64N23O5;Initial Catalog=MalaabDB;Integrated Security=True;Encrypt=False";

              connectionString = $"Data Source={serverName};Initial Catalog=MalaabDB;User Id={username};Password={password};Encrypt=False";
            }
            else
            {
